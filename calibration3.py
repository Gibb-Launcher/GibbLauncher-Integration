...
while True:
    ...
    if frame is not None:
        ...
        cv2.circle(frame, (184, 144), 5, (0, 0, 255), -1) #1 superior esquerdo
        cv2.circle(frame, (429,159), 5, (0, 0, 255), -1) #2 superior direito
        cv2.circle(frame, (43, 241), 5, (0, 0, 255), -1) #3 inferior esquerdo
        cv2.circle(frame, (547, 272), 5, (0, 0, 255), -1) #4 inferior direito
    
        pts1 = np.float32([[184, 144], [429, 159], [43, 241], [547, 272]])
